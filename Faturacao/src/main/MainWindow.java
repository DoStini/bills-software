	...
	private void eventHandler() {
		...
		btnEndDay.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(JOptionPane.showConfirmDialog(contentPanel, "Tem a certeza que pretende fechar sessão? Não feche antes das 00:00H", "", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
					EndOfDay();
				}
			}
		});
